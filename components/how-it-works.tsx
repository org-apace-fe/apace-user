...
const HowItWorks: NextPage = () => {
  ...
  return (
    <div className="relative bg-apace-black text-white min-h-full py-8 overflow-hidden ">
      <div className="absolute" style={{ bottom: "30em", right: "-6rem" }}>
        <BigAIcon />
      </div>
      {/* container strart */}
      <div className="relative flex lg:flex-row-reverse flex-col  my-16">
        <Container> </Container>
        <div className="lg:w-1/2 w-full lg:ml-8 ml-0">
          ...
          <div className="w-5/6 my-10">
            <p>
              You can have anything you want, from anywhere you love, as long as
              you use Apace at checkout.
            </p>
          </div>
      ...
      <div
        className="bg-apace-gray lg:py-32 py-0   relative flex lg:flex-row flex-col mt-32 mb-16"
        style={{
