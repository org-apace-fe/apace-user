      ...
      tempArr.push({
        ...
        status: (
          <div className="flex items-center">
            <div
              className={`w-2 h-2 rounded-full ${ColorButton(
                a?.status
              )}  mr-2 `}
            ></div>
            <p> {a?.status} </p>
              ...
              <div className="min-w-lg lg:min-w-max max-h-screen border-b border-gray-600 pb-6 mb-6 flex items-center lg:justify-between lg:px-28 px-10">
                ...
                <div className="flex cursor-pointer ">
                  ...
                  >
                    ...
                    <p className="ml-2 whitespace-nowrap">Ask for a refund</p>
                  </div>
                  <div
                    onClick={() =>
                      dispatch(
                  ...
                  >
                    ...
                    <p className="ml-2 whitespace-nowrap ">Make a complaint</p>
                  </div>
                  <div
                    onClick={() =>
                      dispatch(
                  ...
                  >
                    ...
                    <p className="ml-2 whitespace-nowrap">Report a purchase</p>
                  </div>
                </div>
              </div>
            </div>
